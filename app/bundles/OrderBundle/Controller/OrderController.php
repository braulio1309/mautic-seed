...
class OrderController extends AbstractStandardFormController
{
            ...
            return $this->postActionRedirect(
                $this->getPostActionRedirectArguments(
                    [
                        ...
                        'contentTemplate' => 'OrderBundle:Order:order_list.html.php',
                        'passthroughVars' => [
    ...
    public function newAction($objectAction = null, $objectId = null)
    {
        ...
        if ($isPost) {
            ...
            if (!$cancelled = $this->isFormCancelled($form)) {
                if ($valid = $this->isFormValid($form)) {
                    ...
                    $template       = 'OrderBundle:Order:index';
                ...
                $viewParameters = ['page' => $page];
                $returnUrl      = $this->generateUrl('order_list', $viewParameters);
                $template       = 'OrderBundle:Product:index';
            }
        ...
        $delegateArgs = [
            ...
            'contentTemplate' => 'OrderBundle:Order:order_create.html.php',
            'passthroughVars' => [
                'mauticContent' => 'order',
