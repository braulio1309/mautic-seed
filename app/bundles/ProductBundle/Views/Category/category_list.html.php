...
if ('index' == $tmpl) {
    $view->extend('ProductBundle:Category:index.html.php');
}
    ...
    <div class="panel-footer">
        <?php echo $view->render(
            ...
            [
                ...
                'baseUrl'    => $view['router']->path('category_list'),
                'sessionVar' => 'campaign',
            ]
        ); ?>
    </div>
<?php else: ?>
    <?php echo $view->render('MauticCoreBundle:Helper:noresults.html.php', ['tip' => 'Create a new category']); ?>
<?php endif; ?>
