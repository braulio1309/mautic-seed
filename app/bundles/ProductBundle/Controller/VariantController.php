...
class VariantController extends AbstractStandardFormController
{
    ...
    public function newAction($objectAction = null, $objectId = null)
    {
        ...
        if ($isPost) {
            ...
            if (!$cancelled = $this->isFormCancelled($form)) {
                if ($valid = $this->isFormValid($form)) {
                    ...
                    $template       = 'ProductBundle:Variant:index';
        ...
        $delegateArgs = [
            ...
            'contentTemplate' => 'ProductBundle:Variant:variant_create.html.php',
            'passthroughVars' => [
                'mauticContent' => 'product',
